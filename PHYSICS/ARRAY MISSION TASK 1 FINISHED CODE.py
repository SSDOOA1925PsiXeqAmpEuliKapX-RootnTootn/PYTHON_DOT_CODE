...
dt = 10  # Smoother time step, as you noted
prev_mag = norm(r)
flip_count = 0
flip_times = []
...
# Note, the above code is henceforth unused. I don't think I learned anything valuable and therefore I have decided to forget it